...
#     #(x0,y0,x1,y1)
#     circleA = canvas.create_oval(490, 50, 560, 115, fill="white", outline='white')
#     textA = canvas.create_text(525, 85, fill='black', font='arial 20 bold', text='A')
#
#     circleB = canvas.create_oval(350, 180, 420, 250, fill="white", outline='white')
#     textB = canvas.create_text(385, 215, fill='black', font='arial 20 bold', text='B')
#
#     circleC = canvas.create_oval(600, 180, 670, 250, fill="white", outline='white')
#     textC = canvas.create_text(635, 215, fill='black', font='arial 20 bold', text='C')
#
#     circleD = canvas.create_oval(250, 310, 320, 380, fill="white", outline='white')
#     textD = canvas.create_text(285, 345, fill='black', font='Times 20 bold', text='D')
#
#     circleE = canvas.create_oval(420, 310, 490, 380, fill="white", outline='white')
#     textE = canvas.create_text(455, 345, fill='black', font='Times 20 bold', text='E')
#
#     circleF = canvas.create_oval(540, 310, 610, 380, fill="white", outline='white')
#     textF = canvas.create_text(575, 345, fill='black', font='Times 20 bold', text='F')
#
#     circleG = canvas.create_oval(680, 310, 750, 380, fill="white", outline='white')
#     textG = canvas.create_text(715, 345, fill='black', font='Times 20 bold', text='G')
#
#     circleH = canvas.create_oval(150, 450, 220, 520, fill="white", outline='white')
#     textH = canvas.create_text(185, 485, fill='black', font='Times 20 bold', text='H')
#
#     circleI = canvas.create_oval(320, 450, 390, 520, fill="white", outline='white')
#     textI = canvas.create_text(355, 485, fill='black', font='Times 20 bold', text='I')
#
#     circleJ = canvas.create_oval(470, 450, 545, 520, fill="white", outline='white')
#     textJ = canvas.create_text(505, 485, fill='black', font='Times 20 bold', text='J')
#
#     canvas.create_line(520, 115, 410, 190, arrow=tk.LAST, fill="black")  # A-B
#     canvas.create_line(520, 115, 630, 180, arrow=tk.LAST, fill="black")  # A-C
#
#     canvas.create_line(380, 250, 445, 315, arrow=tk.LAST, fill="black")  # B-E
#     canvas.create_line(380, 250, 305, 325, arrow=tk.LAST, fill="black")  # B-D
#
#     canvas.create_line(630, 250, 695, 315, arrow=tk.LAST, fill="black")  # C-G
#     canvas.create_line(630, 250, 565, 315, arrow=tk.LAST, fill="black")  # C-F
#
#     canvas.create_line(280, 380, 350, 450, arrow=tk.LAST, fill="black")  # D-J
#     canvas.create_line(280, 380, 210, 450, arrow=tk.LAST, fill="black")  # D-I
#
#     canvas.create_line(570, 380, 515, 450, arrow=tk.LAST, fill="black")  # I-L
#     # canvas.create_line(480, 380, 550, 450, arrow=tk.LAST, fill="black") #I-K
#     boy = "boy"
#     # canvas.itemconfig(circleC, fill="green")
#     canvas.pack()
#
import collections
